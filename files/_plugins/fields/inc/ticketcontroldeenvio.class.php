...
class PluginFieldsTicketcontroldeenvio extends PluginFieldsAbstractContainerInstance
{
   ...
   static function install() {
      ...
      if (!$DB->tableExists($table)) {
         $query = "CREATE TABLE IF NOT EXISTS `$table` (
                  ...
                  `plugin_fields_containers_id`      INT          {$default_key_sign} NOT NULL DEFAULT " . var_export(3, true) . ",
                  PRIMARY KEY                        (`id`),
