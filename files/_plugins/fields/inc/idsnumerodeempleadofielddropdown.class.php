...
class PluginFieldsIdsnumerodeempleadofieldDropdown extends CommonTreeDropdown {
   public $field_name      = 'idsnumerodeempleadofield';
   ...
   static function install() {
      ...
      $plugin_fields_fieldname_dropdowns_id = 'plugin_fields_' . preg_replace('/[^a-zA-Z0-9_]/', '', 'idsnumerodeempleadofield') . 'dropdowns_id';
