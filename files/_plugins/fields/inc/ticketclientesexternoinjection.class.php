...
class PluginFieldsTicketclientesexternoInjection extends PluginFieldsTicketclientesexterno implements PluginDatainjectionInjectionInterface
{
    ...
    **/
    ...
    static function getTypeName($nb = 0) {
        $itemtype = 'Ticket';
        $container_name = 'Clientes Externos';
