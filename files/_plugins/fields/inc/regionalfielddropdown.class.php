...
class PluginFieldsRegionalfieldDropdown extends CommonTreeDropdown {
   public $field_name      = 'regionalfield';
   ...
   static function install() {
      ...
      $plugin_fields_fieldname_dropdowns_id = 'plugin_fields_' . preg_replace('/[^a-zA-Z0-9_]/', '', 'regionalfield') . 'dropdowns_id';
