...
class PluginFieldsTicketcontroldeactivoInjection extends PluginFieldsTicketcontroldeactivo implements PluginDatainjectionInjectionInterface
{
    ...
    **/
    ...
    static function getTypeName($nb = 0) {
        $itemtype = 'Ticket';
        $container_name = 'Control de Activos';
    ...
    **/
    function getOptions($primary_type='') {
        ...
        $searchoptions = PluginFieldsContainer::getAddSearchOptions('Ticket', $container_id);
