...
class PluginFieldsTicketcontroldeenvioInjection extends PluginFieldsTicketcontroldeenvio implements PluginDatainjectionInjectionInterface
{
    ...
    **/
    ...
    static function getTypeName($nb = 0) {
        $itemtype = 'Ticket';
        $container_name = 'Control de Envios';
