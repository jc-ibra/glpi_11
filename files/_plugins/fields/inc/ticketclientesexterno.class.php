...
class PluginFieldsTicketclientesexterno extends PluginFieldsAbstractContainerInstance
{
   ...
   static function install() {
      ...
      if (!$DB->tableExists($table)) {
         $query = "CREATE TABLE IF NOT EXISTS `$table` (
                  ...
                  `itemtype`                         VARCHAR(255) DEFAULT " . var_export('Ticket', true) . ",
                  `plugin_fields_containers_id`      INT          {$default_key_sign} NOT NULL DEFAULT " . var_export(1, true) . ",
                  PRIMARY KEY                        (`id`),
      ...
      */
      if (getItemForItemtype('Ticket'::class)->isEntityAssign() && !$DB->fieldExists($table, 'entities_id')) {
      ...
      */
      if (
         getItemForItemtype('Ticket'::class)->maybeRecursive()
