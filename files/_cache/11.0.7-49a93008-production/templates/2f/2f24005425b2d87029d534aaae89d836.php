...
class __TwigTemplate_0a7df3c99148a69e033319f3f64c8be0 extends Template
{
...
";
        ...
        if ((($tmp =  !Twig\Extension\CoreExtension::testEmpty(($context["connect_string"] ?? null))) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 97
            yield "   ";
            yield $macros["fields"]->getTemplateForMacro("macro_htmlField", $context, 97, $this->getSourceContext())->macro_htmlField(...["", $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(($context["connect_string"] ?? null)), __("Connection string"), ["add_field_class" => "fw-bold", "full_width" => true]]);
            // line 100
            yield "
";
        }
    ...
    {
        return new Source("", "pages/setup/mailcollector/server_config_fields.html.twig", "/home/t7x4o9pmpeuw/public_html/helpdesk.trantortechnologies.mx/templates/pages/setup/mailcollector/server_config_fields.html.twig");
    }
}
