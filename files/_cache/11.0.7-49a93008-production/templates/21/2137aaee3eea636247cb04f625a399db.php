...
class __TwigTemplate_b2a16dbb25c1f48b166a5165538c8e09 extends Template
{
...
<form method=\"post\" action=\"";
    ...
    ";
        ...
        if ((get_class(($context["item"] ?? null)) == "KnowbaseItem")) {
            ...
            // line 50
            yield "            ";
            yield $macros["fields"]->getTemplateForMacro("macro_htmlField", $context, 50, $this->getSourceContext())->macro_htmlField(...["", ($context["dropdown"] ?? null), __("Add a linked item")]);
            yield "
        ";
        } else {
            // line 52
            yield "            ";
            yield $this->extensions['Glpi\Application\View\Extension\ItemtypeExtension']->getItemtypeDropdown("KnowbaseItem", ["entity" => CoreExtension::getAttribute($this->env, $this->source,             // line 53
($context["item"] ?? null), "getEntityID", [], "method", false, false, false, 53), "used" =>             // line 54
($context["used_knowbase_items"] ?? null), "condition" =>             // line 55
($context["visibility_condition"] ?? null)]);
        ...
        yield "        <div>
            ";
        // line 59
        yield $macros["inputs"]->getTemplateForMacro("macro_submit", $context, 59, $this->getSourceContext())->macro_submit(...["add", _x("button", "Add"), 1, ["class" => "btn btn-primary ms-1", "icon" => "ti ti-link"]]);
        yield "
        </div>
    </div>
</form>
";
    ...
    {
        return array (  114 => 59,  111 => 58,  107 => 56,  105 => 55,  104 => 54,  103 => 53,  101 => 52,  95 => 50,  91 => 49,  88 => 48,  85 => 47,  83 => 46,  81 => 45,  78 => 44,  73 => 42,  68 => 41,  62 => 39,  60 => 38,  56 => 37,  52 => 36,  49 => 35,  47 => 34,  45 => 33,  42 => 32,);
    }

    public function getSourceContext(): Source
    {
        return new Source("", "pages/tools/kb/knowbaseitem_item.html.twig", "/Users/carlosperez/Documents/Dev/php/glpi_11/templates/pages/tools/kb/knowbaseitem_item.html.twig");
    }
}
