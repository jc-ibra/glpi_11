...
class __TwigTemplate_833ab44457fd47b8af42430942407910 extends Template
{
...
";
        ...
        ";
            ...
            if ((array_key_exists("token", $context) || (($context["type"] ?? null) == "update"))) {
                ...
                yield (((array_key_exists("token", $context) &&  !(null === $context["token"]))) ? ($this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($context["token"], "html", null, true)) : (""));
                yield "\" />
            ";
                // line 69
...
";
    ...
    {
        return new Source("", "password_form.html.twig", "/home/t7x4o9pmpeuw/public_html/helpdesk.trantortechnologies.mx/templates/password_form.html.twig");
    }
}
