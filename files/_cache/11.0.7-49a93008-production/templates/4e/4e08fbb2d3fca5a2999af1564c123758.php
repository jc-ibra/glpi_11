...
class __TwigTemplate_a18752e2c8db6ce0962f55cf8faa64b2 extends Template
{
...
($context["item"] ?? null), "fields", [], "any", false, false, false, 76)) && is_array($_v4) || $_v4 instanceof ArrayAccess ? ($_v4["sent_try"] ?? null) : null), __("Number of retries"), ["min" => 0, "max" => 255]]);
    ...
    <script>
        ...
        const editor_container_id = '";
        // line 96
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(($context["url_editor_container_id"] ?? null), "js"), "html", null, true);
        yield "';
        window.GLPI.Monaco.createEditor(editor_container_id, 'twig', '";
        // line 97
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape((($_v5 = CoreExtension::getAttribute($this->env, $this->source, ($context["item"] ?? null), "fields", [], "any", false, false, false, 97)) && is_array($_v5) || $_v5 instanceof ArrayAccess ? ($_v5["url"] ?? null) : null), "js"), "html", null, true);
        yield "', ";
        yield json_encode(($context["response_schema"] ?? null));
        yield ", editor_options).then(() => {
            \$(`#\${CSS.escape(editor_container_id)}`).closest('form').on('formdata', (e) => {
            ...
            \$(`#\${CSS.escape(editor_container_id)}`).closest('form').find('select[name=\"itemtype\"]').on('change', (e) => {
                ...
                \$.ajax({
                    ...
                    success: (data) => {
                        ...
                        window.GLPI.Monaco.createEditor(editor_container_id, 'twig', url_field_value, data, editor_options);
                    }
                });
            });
        });
    ...
    ";
        // line 129
        yield $macros["fields"]->getTemplateForMacro("macro_dropdownArrayField", $context, 129, $this->getSourceContext())->macro_dropdownArrayField(...["http_method", (($_v6 = CoreExtension::getAttribute($this->env, $this->source,         // line 131
($context["item"] ?? null), "fields", [], "any", false, false, false, 131)) && is_array($_v6) || $_v6 instanceof ArrayAccess ? ($_v6["http_method"] ?? null) : null), CoreExtension::getAttribute($this->env, $this->source,         // line 132
($context["item"] ?? null), "getHttpMethod", [], "method", false, false, false, 132), __("HTTP method"),         // line 134
($context["field_options"] ?? null)]);
    ...
    ";
        ...
        if ((($tmp = Twig\Extension\CoreExtension::constant("GLPI_WEBHOOK_ALLOW_RESPONSE_SAVING")) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 138
            yield "        ";
            yield $macros["fields"]->getTemplateForMacro("macro_dropdownYesNo", $context, 138, $this->getSourceContext())->macro_dropdownYesNo(...["save_response_body", (($_v7 = CoreExtension::getAttribute($this->env, $this->source, ($context["item"] ?? null), "fields", [], "any", false, false, false, 138)) && is_array($_v7) || $_v7 instanceof ArrayAccess ? ($_v7["save_response_body"] ?? null) : null), __("Save response body")]);
            yield "
    ";
        }
        // line 140
    ...
    ";
        // line 141
        yield $macros["fields"]->getTemplateForMacro("macro_dropdownYesNo", $context, 141, $this->getSourceContext())->macro_dropdownYesNo(...["log_in_item_history", (($_v8 = CoreExtension::getAttribute($this->env, $this->source, ($context["item"] ?? null), "fields", [], "any", false, false, false, 141)) && is_array($_v8) || $_v8 instanceof ArrayAccess ? ($_v8["log_in_item_history"] ?? null) : null), __("Log in item history")]);
        yield "
...
";
    ...
    {
        return array (  193 => 141,  190 => 140,  184 => 138,  182 => 137,  178 => 135,  176 => 134,  175 => 132,  174 => 131,  173 => 129,  136 => 97,  132 => 96,  127 => 93,  124 => 90,  117 => 88,  114 => 87,  112 => 86,  107 => 84,  103 => 82,  101 => 76,  100 => 74,  97 => 73,  95 => 65,  94 => 64,  90 => 62,  88 => 59,  87 => 58,  86 => 56,  85 => 55,  84 => 53,  80 => 51,  78 => 49,  77 => 48,  76 => 47,  75 => 45,  74 => 44,  73 => 42,  68 => 40,  65 => 39,  58 => 38,  53 => 33,  51 => 36,  49 => 35,  47 => 34,  40 => 33,);
    }

    public function getSourceContext(): Source
    {
        return new Source("", "pages/setup/webhook/webhook.html.twig", "/Users/carlosperez/Documents/Dev/php/glpi_11/templates/pages/setup/webhook/webhook.html.twig");
    }
}
