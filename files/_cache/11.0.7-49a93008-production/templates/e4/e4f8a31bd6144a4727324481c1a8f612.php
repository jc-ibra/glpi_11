...
class __TwigTemplate_2a527d9c7a3b33177bde06d5c6ef4a46 extends Template
{
    ...
    ";
            ...
            // line 46
            yield "        ";
            yield $macros["fields"]->getTemplateForMacro("macro_htmlField", $context, 46, $this->getSourceContext())->macro_htmlField(...["", $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape((($_v1 = CoreExtension::getAttribute($this->env, $this->source, ($context["item"] ?? null), "fields", [], "any", false, false, false, 46)) && is_array($_v1) || $_v1 instanceof ArrayAccess ? ($_v1["view"] ?? null) : null)), __("Views")]);
            yield "
    ";
        }
        // line 48
    ...
    ";
            ...
            // line 59
            yield "        ";
            yield $macros["fields"]->getTemplateForMacro("macro_htmlField", $context, 59, $this->getSourceContext())->macro_htmlField(...["", ($context["faq_label"] ?? null), null, ["no_label" => true]]);
            // line 61
            yield "
    ";
        }
