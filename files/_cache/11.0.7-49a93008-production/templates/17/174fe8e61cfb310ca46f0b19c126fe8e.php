...
class __TwigTemplate_9715aac61d44a29a2cae4cbf77a7321f extends Template
{
...
($context["item"] ?? null), "fields", [], "any", false, false, false, 66)) && is_array($_v3) || $_v3 instanceof ArrayAccess ? ($_v3["scopes"] ?? null) : null)]]);
        ...
        if ((($tmp =  !CoreExtension::getAttribute($this->env, $this->source, ($context["item"] ?? null), "isNewItem", [], "method", false, false, false, 71)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 72
            yield "                                ";
            yield $macros["fields"]->getTemplateForMacro("macro_passwordField", $context, 72, $this->getSourceContext())->macro_passwordField(...["secret", $this->extensions['Glpi\Application\View\Extension\SecurityExtension']->decrypt((($_v4 = CoreExtension::getAttribute($this->env, $this->source, ($context["item"] ?? null), "fields", [], "any", false, false, false, 72)) && is_array($_v4) || $_v4 instanceof ArrayAccess ? ($_v4["secret"] ?? null) : null)), __("Client Secret"), ["is_disclosable" => true, "readonly" => true]]);
            // line 75
            yield "
                            ";
        }
...
($context["field_options"] ?? null)]);
    ...
    {
        return new Source("", "pages/setup/oauthclient.html.twig", "/home/t7x4o9pmpeuw/public_html/helpdesk.trantortechnologies.mx/templates/pages/setup/oauthclient.html.twig");
    }
}
