 ...
 */
class Glpi_Kernel_KernelProductionDebugContainer extends Container
{
    protected $targetDir;
    ...
    public function __construct(private array $buildParameters = [], protected string $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'Glpi\\Controller\\Config\\LDAPController' => 'getLDAPControllerService',
            ...
            'Glpi\\Controller\\Form\\QuestionDropdownValuesController' => 'getQuestionDropdownValuesControllerService',
        ...
        $this->privates['service_container'] = static function ($container) {
            ...
            include_once \dirname(__DIR__, 5).'/src/Glpi/Kernel/Kernel.php';
            include_once \dirname(__DIR__, 5).'/src/Glpi/Http/RequestRouterTrait.php';
            include_once \dirname(__DIR__, 5).'/src/Glpi/Http/SessionManager.php';
            include_once \dirname(__DIR__, 5).'/vendor/symfony/event-dispatcher/EventSubscriberInterface.php';
            include_once \dirname(__DIR__, 5).'/src/Glpi/Kernel/Listener/ControllerListener/CheckCsrfListener.php';
            include_once \dirname(__DIR__, 5).'/src/Glpi/Kernel/Listener/ControllerListener/FirewallStrategyListener.php';
            include_once \dirname(__DIR__, 5).'/src/Glpi/Http/Firewall.php';
            include_once \dirname(__DIR__, 5).'/src/Glpi/Kernel/KernelListenerTrait.php';
            include_once \dirname(__DIR__, 5).'/src/Glpi/Kernel/Listener/RequestListener/CatchInventoryAgentRequestListener.php';
            include_once \dirname(__DIR__, 5).'/src/Glpi/Kernel/Listener/RequestListener/CheckDatabaseStatusListener.php';
            include_once \dirname(__DIR__, 5).'/src/Glpi/Kernel/Listener/RequestListener/CheckMaintenanceListener.php';
            include_once \dirname(__DIR__, 5).'/src/Glpi/Kernel/Listener/RequestListener/ErrorHandlerRequestListener.php';
            include_once \dirname(__DIR__, 5).'/src/Glpi/Kernel/Listener/RequestListener/FlushBootErrors.php';
            include_once \dirname(__DIR__, 5).'/src/Glpi/Kernel/Listener/RequestListener/FrontEndAssetsListener.php';
            include_once \dirname(__DIR__, 5).'/src/Glpi/Kernel/Listener/RequestListener/LegacyItemtypeRouteListener.php';
            include_once \dirname(__DIR__, 5).'/src/Glpi/Kernel/Listener/RequestListener/LegacyRouterListener.php';
            include_once \dirname(__DIR__, 5).'/src/Glpi/Kernel/Listener/RequestListener/PluginsRouterListener.php';
            include_once \dirname(__DIR__, 5).'/src/Glpi/Kernel/Listener/RequestListener/RedirectLegacyRouteListener.php';
            include_once \dirname(__DIR__, 5).'/src/Glpi/Kernel/Listener/RequestListener/SessionCheckCookieListener.php';
            include_once \dirname(__DIR__, 5).'/src/Glpi/Kernel/Listener/RequestListener/SessionVariables.php';
            include_once \dirname(__DIR__, 5).'/vendor/psr/container/src/ContainerInterface.php';
            include_once \dirname(__DIR__, 5).'/vendor/symfony/dependency-injection/ContainerInterface.php';
            include_once \dirname(__DIR__, 5).'/src/Glpi/DependencyInjection/PluginContainer.php';
    ...
    {
        if (true === $lazyLoad) {
            return $container->privates['argument_resolver.request_payload'] = $container->createProxy('RequestPayloadValueResolverGhost243220f', static fn () => \RequestPayloadValueResolverGhost243220f::createLazyGhost(static fn ($proxy) => self::getArgumentResolver_RequestPayloadService($container, $proxy)));
        }
    ...
    private function getDynamicParameter(string $name)
    {
        ...
        $value = match ($name) {
            ...
            'debug.container.dump' => ($container->targetDir.''.'/Glpi_Kernel_KernelProductionDebugContainer.xml'),
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'kernel.container_class' => 'Glpi_Kernel_KernelProductionDebugContainer',
            'glpi.default_secret' => '4e61912256a967097c47a64cbf33601fb72c3ed7b426b89e441f6da3b869cfd6',
